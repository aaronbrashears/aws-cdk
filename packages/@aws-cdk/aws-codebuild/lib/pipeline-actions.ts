...
export class PipelineBuildAction extends codepipeline.BuildAction {
  ...
  protected bind(info: codepipeline.IBindInfo): void {
...
export class PipelineTestAction extends codepipeline.TestAction {
  ...
  protected bind(info: codepipeline.IBindInfo): void {
    setCodeBuildNeededPermissions(info, this.props.project, this._outputArtifacts.length > 0);
  }
}

function setCodeBuildNeededPermissions(info: codepipeline.IBindInfo, project: IProject,
